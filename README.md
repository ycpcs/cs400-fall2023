...
NOTE:  Most (if not all) of the capstone projects are external-client driven and, as such, have specific copyright privileges assicated with them.  If you intend to use information from ny of those 
project information, you MUST first contact one of the below listed instructors to obtain permission
