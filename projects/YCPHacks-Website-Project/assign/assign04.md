...
Your task is to create initial analysis and design models which identify the important classes in your system, and their relationships. If your project includes a database, include a database schema showing the tables and fields of the database.

Your goal should be to create a UML design model that will provide a good framework to build upon.  Your initial design model will:
